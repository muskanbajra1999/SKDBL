		        				...
		        				<div class="card">
		        					...
		        					<div class="row">
		        						...
		        						<div class="col-md-2">
		        							<div class="card-tools">
		        								<a class="btn btn-outline-success" href="branch.php">Add BRANCH</a> 
		        							</div>
		        						</div>
		        					...
		        					<div class="card bg-gradient-secondary">
		        						<div class="card-header">
		        							<h3 class="card-title">Product Allocation (Branch)</h3>
		        						</div>
		        									...
		        									foreach ($query3 as $row) {
			        									...
			        									<tr>
			        										...
			        										<!-- <td class="project-actions text-right">	
	                          									<a class="btn btn-primary"  href="editbranchad.php?vid=<?php echo $row['vid']; ?>">
