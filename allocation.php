		        			...
		        			<div class="col-md-12">
	        					<div class="card bg-gradient-secondary">
	        						<div class="card-header">
	        							<h3 class="card-title">Product Allocation</h3>
	        						</div>
	        							...
	        							<table class="table table-striped">
	        								<thead class="bg-success">
	        									<tr>
	        										...
	        										<th style="width: 16%;">Product Specification</th>
	        								...
	        								<tbody>
	        									...
	        									$count = 0;
	        									$i = 0;
	        									$query3 = mysqli_query($con, "SELECT branch.branchName, department.departmentName, productdetails.pid, pName, pSpecification, pSCategory, cName, SUM(quantity) as quantity, allocationdetails.aid, allocationdetails.entryDate FROM productdetails JOIN subcategorydetails ON subcategorydetails.scName = productdetails.pSCategory JOIN categorydetails ON categorydetails.cCode = subcategorydetails.cCode JOIN allocationdetails ON allocationdetails.pid = productdetails.pid JOIN branch ON branch.branchCode = allocationdetails.branchCode JOIN department ON department.departmentCode = allocationdetails.departmentCode GROUP BY branchName, pName ORDER BY branchName ASC");
	        									foreach ($query3 as $row) {
		        									...
		        									<tr>
		        										<td><?php echo $i; ?></td>
		        										<td><?php echo $row['branchName'] . " - " . $row['departmentName']; ?></td>
		        										...
		        										<td class="project-actions text-right">	
                          									<a class="btn btn-primary"  href="editallocation.php?aid=<?php echo $row['aid']; ?>">
