	        							...
	        							<table class="table table-striped">
	        								...
	        								<tbody>
	        									...
	        									foreach ($query3 as $row) {
		        									...
		        									<tr>
		        										<td><?php echo $i; ?></td>
		        										<td><?php echo $row['vName'] . ", " . $row['vAddress']; ?></td>
		        										<td><?php echo $row['pid']; ?></td>
		        										<td><?php echo $row['pName']; ?></td>
		        										<td><?php echo $row['pSpecification']; ?></td>
		        										<td><?php echo $row['pCompany']; ?></td>
		        										<td><?php echo $row['pRate']; ?></td>
		        										<td><?php echo $row['pSCategory']; ?></td>
		        										<td><?php echo $row['total']; ?></td>
		        										<td><?php echo $row['inStock']; ?></td>
		        										<td class="project-actions text-right">	
                          									<a class="btn btn-primary btn-block"  href="additemsvendor.php?pid=<?php echo $row['pid']; ?>">
